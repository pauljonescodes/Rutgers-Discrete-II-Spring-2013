...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item There are 8 ways of getting 1, $\{6 - 5, 5 - 6, 4 - 3, 3 - 4, 3 - 2, 2 - 3, 2 - 1, 1 - 2\}$. For $i = 1$,
		      \[ 1 \times P(X = 1) = 1 \times \frac{8}{36} = \frac{2}{9} \]
		\item There are 8 ways of getting 2, $\{6 - 4, 4 - 6, 5 - 3, 3 - 5, 4 - 2, 2 - 4, 1 - 5, 5 - 1\}$. For $i = 2$,
			  \[ 2 \times P(X = 2) = 2 \times \frac{8}{36} = \frac{4}{9}\]
		\item There are 8 ways of getting 3, $\{6 - 3, 3 - 6, 5 - 2, 2 - 5, 4 - 1, 1 - 4, 1 - 2, 2 - 1\}$. For $i = 3$,
			  \[ 3 \times P(X = 3) = 3 \times \frac{8}{36} = \frac{2}{3}\]
	    ...
	    \item The expected value,
	    		  \[E(X) = 0 + \frac{2}{9} + \frac{4}{9} + \frac{2}{3} + \frac{4}{9} +  \frac{5}{18} = 2.0555555556 \approx 2\]
